<nav id="fixed-nav" class="-translate-y-full fixed flex z-20 w-full text-black transition-all bg-gray-100 sm:justify-between  px-10">
    ...
    <div class="hidden flex gap-1 items-center mr-6">
    ...
    <a class="flex laptop:hidden flex-col py-1 my-1 gap-1 self-center">
      <div class="w-7 h-1 bg-green-700 rounded"></div>
      <div class="w-7 h-1 bg-green-700 rounded"></div>
      <div class="w-7 h-1 bg-green-700 rounded"></div>
    </a>
</nav>